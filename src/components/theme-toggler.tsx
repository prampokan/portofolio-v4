...
export function ThemeToggler() {
  ...
  const getThemeColor = (theme?: string) => {
    switch (theme) {
      case "light":
        return "from-zinc-300 to-white";
      case "dark":
        return "from-zinc-950 to-zinc-500";
      case "blue":
        return "from-blue-900 to-blue-500";
      case "red":
        return "from-red-950 to-red-500";
      default:
        return "from-zinc-300 to-white";
    }
  };
    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button variant="ghost" size="icon" className="rounded-full">
          <div
            className={`w-5 h-5 rounded-full bg-gradient-to-tl ${getThemeColor(
              theme,
            )}`}
          />
        </Button>
      ...
      <PopoverContent className="rounded-xl bg-background/50 backdrop-blur">
        ...
        <div className="mt-3 grid grid-cols-4">
          ...
          <Button
            ...
            className="rounded-full"
          >
            <div className="w-5 h-5 bg-gradient-to-tl from-red-950 to-red-500 rounded-full"></div>
          </Button>
        </div>
      </PopoverContent>
    </Popover>
